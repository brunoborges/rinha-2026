...
final class KdTreeScratch {
    ...
    final int[]           refineIds       = new int[TopKSortedArray.MAX_K];
    final int[]           refineSums      = new int[TopKSortedArray.MAX_K];
    ...
    int topKReplaced;
    boolean refinedLast;
    int refineApproxVisits;
    int refineExactVisits;
    float finalPeekDist;
    ...
    final int[]   bbfExtra = new int[BBF_HEAP_CAP];
    final int[]   bbfThreshold = new int[BBF_HEAP_CAP];
